...
{
    [ApiController]
    [Route("api/page/configuration/evaluation-flow")]
    public class EvaluationFlowController : ControllerBase
    {
        private readonly IEvaluationFlowService _service;
        private readonly ILogger<EvaluationFlowController> _logger;

        public EvaluationFlowController(IEvaluationFlowService service, ILogger<EvaluationFlowController> logger)
        {
            _service = service;
            _logger = logger;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] CreateEvaluationFlowRequest request)
        {
            try
            {
        ...
        [HttpPut("{code}")]
        public async Task<IActionResult> Update(string code, [FromBody] UpdateEvaluationFlowRequest request)
        {
            try
            {
        ...
        public async Task<IActionResult> Delete(string code)
        {
            try
            {
                ...
                return Ok(new { message = "Evaluation flow deleted successfully" });
            }
            catch (Exception ex)
            {
        ...
        [HttpDelete]
        public async Task<IActionResult> DeleteMany([FromBody] DeleteManyEvaluationFlowRequest request)
        {
            try
            {
